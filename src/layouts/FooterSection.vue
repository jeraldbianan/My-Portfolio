<template>
  <footer
    class="mobile:px-[30px] mobile:justify-center flex bg-dark-grey px-[60px] py-10 dark:bg-main-white"
  >
    <div
      class="tablet:flex-wrap mobile:flex-col mobile:items-center flex w-full max-w-container justify-between"
    >
      ...
      >
        <div class="mobile:flex mobile:flex-col mobile:items-center w-[168px]">
          <h3
